      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600">
            Choose how you'd like to connect your shop to get started
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <div className="bg-green-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-center text-green-800">
                  ...
                  <span className="text-sm font-medium">Automatic integration</span>
                </div>
              </div>
          ...
          >
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6 leading-relaxed">
                Connect your Ikas e-commerce store using your API credentials
              </p>
              ...
              <div className="bg-purple-50 rounded-lg p-4 mb-6">
                <div className="flex items-center justify-center text-purple-800">
                  ...
                  <span className="text-sm font-medium">API-based connection</span>
                </div>
              </div>
        ...
        <div className="mt-12 text-center">
          <div className="bg-white rounded-xl shadow-lg p-6 max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 text-sm leading-relaxed">
              Our platform supports various e-commerce platforms. Choose Shopify for automatic OAuth integration, 
              Ikas for API-based connection, or upload your product data via XML/CSV files for other platforms.
            </p>
          </div>
        </div>
      </div>
